...
3. Resolve the governing GitHub Issue.
4. Use the most specific Skill/SOP/Workflow available.
5. Prefer existing/native capability before building anything new.
6. Verify the smallest useful result.
