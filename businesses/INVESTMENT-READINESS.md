...
**Governing issue:** #60  
**Latest targeted rebuild:** DRF Portfolio Intelligence calibration — Revenue Recovery, AI Voice and Missed Lead Conversion — Issue #123 — 1 September 2026  
...
| **2** | **Talent Bridge Assessment & AI Interview Platform** | Produce faster, more consistent screening, assessment and interview evidence for hiring decisions. | **89** | Pending | Pending | RESEARCH | $0 | Pending | No | Separate sale/subscription/usage streams and model licensing, review and compliance. |
| **2** | **Agentic Commerce Visibility & Conversion Engine** | Make merchants easier for AI agents to discover, understand and convert into attributable sales. | **89** | Pending | Pending | RESEARCH | $0 | Pending | No | Rebuild merchant price, attributable sales lift, retention and channel economics. |
