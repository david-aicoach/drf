...
Standard structures for recurring DRF outputs. Use only the files required by the current proof stage; do not create paperwork before it buys a decision or evidence.

## Revenue Blueprint Factory pack
...
PROOF
underwrite → backtest → forward test → payment/value → repeatability → scale

RETURN
capital → founder hours → monthly cash → payback → annual ROI → downside
...
- Workflow: [`../../workflows/revenue-blueprint-factory.md`](../../workflows/revenue-blueprint-factory.md)
- Scoring and proof standard: [`../guidelines/revenue-blueprint-scoring-and-investment-readiness.md`](../guidelines/revenue-blueprint-scoring-and-investment-readiness.md)
- Research basis: [`../../research/revenue-blueprint-factory-benchmark-research-2026-08-31.md`](../../research/revenue-blueprint-factory-benchmark-research-2026-08-31.md)
- Sales-language lesson: [`../lessons/revenue-documentation-must-speak-sales-language.md`](../lessons/revenue-documentation-must-speak-sales-language.md)

For full business-opportunity research, this pack takes precedence over the generic `research-output.md` template.

## Other templates

- [`business-experiment.md`](./business-experiment.md) — small commercial experiment where the full RBF-7 pack is not yet required.
- [`research-output.md`](./research-output.md) — generic decision research that is not a business underwriting exercise.
